-- Migration to restore catalog hierarchy (series, models, alt_models, trims)
-- Preserves existing brand logo_url values

-- Clear existing series/models/alt_models/trims (but NOT brands or classes)
TRUNCATE vehicle_catalog_trims CASCADE;
TRUNCATE vehicle_catalog_alt_models CASCADE;
TRUNCATE vehicle_catalog_models CASCADE;
TRUNCATE vehicle_catalog_series CASCADE;
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND m.name = '2.9';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 120, 1368
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 170, 1368
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'Distinctive';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 120, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 235, 1742
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 103, 1370
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TS STD';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 103, 1596
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'L';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 120, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 129, 1712
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND m.name = '1.7';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 155, 1970
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 150, 1970
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TS QV';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 103, 1370
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 125, 1601
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TS';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 150, 1900
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'L';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 120, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'Progression';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Dizel', 'Manuel', 150, 1910
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'JTD Q2';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 150, 1970
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'Distinctive';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 150, 1970
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TB';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 94, 1490
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 132, 1712
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'TB';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Dizel', 'Manuel', 85, 1248
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'City';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 155, 1300
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'Distinctive';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 170, 1368
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 135, 1368
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 150, 1201
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 155, 1368
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Dizel', 'Manuel', 120, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Alfa Romeo' 
  ...
  AND am.name = 'Prograssion';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Elektrik', 'Otomatik', 200, NULL
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alpine' 
  ...
  AND m.name = 'GT';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Elektrik', 'Otomatik', 225, 1300
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Alpine' 
...
WHERE b.name = 'Anadol' 
  ...
  AND m.name = 'A2 SL';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 75, 1301
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Anadol' 
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 122, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 90, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = 'Attraction';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 100, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = 'S Line';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = 'Sport';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 75, 1390
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.4 TFSI', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attaction', 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.6', 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 101, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attaction', 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.6 FSI', 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 115, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 FSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 3 KapÄ±', 'Dizel', 'Otomatik', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 3 KapÄ±', 'Dizel', 'Otomatik', 125, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attaction', 'Hatchback 3 KapÄ±', 'Dizel', 'Otomatik', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 3 KapÄ±', 'Benzin + LPG', 'Manuel', 125, 1781
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 125, 1601
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attaction', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 150, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attaction', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 105, 1896
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.9 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'S - Line', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 200, 1801
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.9 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 3 KapÄ±', 'Benzin', 'Otomatik', NULL, NULL
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 FSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '2.0 TDI', 'Hatchback 3 KapÄ±', 'Dizel', 'Manuel', 140, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Design', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Dynamic', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Advanced', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 110, 999
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Dynamic', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 116, 999
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'S Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 110, 999
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '30 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Advanced', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'All Street', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Design', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Dynamic', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'S Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1498
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '35 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Design Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 116, 999
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.0 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 116, 999
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.0 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 110, 1197
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.2 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 110, 1197
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.2 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.4 TFSI', 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 125, 1395
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 125, 1390
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport Line', 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 125, 1601
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.5 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.6', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 102, 1595
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 100, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 FSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Standart', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 110, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 105, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 110, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 110, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Design Line', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport Line', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 116, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.6 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 125, 1781
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambiente', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 150, 1781
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8 T';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 160, 1798
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 160, 1798
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '1.9 TDI', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 150, 1801
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.9 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Attraction', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 125, 1801
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.9 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 150, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 FSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, '2.0 TDI', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 140, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 140, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition Qutro', 'Hatchback 5 KapÄ±', 'Dizel', 'Manuel', 140, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Ambition Qutro', 'Hatchback 3 KapÄ±', 'Benzin', 'Manuel', 275, 3001
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TFSI Quattro';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quattro Advance', 'Hatchback 5 KapÄ±', 'Hibrit', 'Otomatik', 204, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '40 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quattro Design', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 190, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '40 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quatro S Line', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 204, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '40 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quattro Sport', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 190, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '40 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quattro Advance', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 265, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '45 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Quatro S Line', 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 265, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '45 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 150, 1395
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.4 TFSI Sport';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 160, 1798
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '1.8 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 200, 1801
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 190, 1968
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TDI Quattro Sport';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 180, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TFSI';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 211, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TFSI Quattro';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, 'Sport', 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 252, 1984
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Audi' 
  ...
  AND am.name = '2.0 TFSI Quattro';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Dizel', 'Otomatik', 240, 2967
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Buick' 
  ...
  AND m.name = '2.4';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Elektrik', 'Otomatik', 204, NULL
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'BYD' 
...
WHERE b.name = 'BYD' 
  ...
  AND m.name = 'Confort';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Elektrik', 'Otomatik', 225, NULL
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'BYD' 
...
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 119, 1597
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chery' 
...
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 136, 1971
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chery' 
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Otomatik', 84, 1297
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chery' 
  ...
  AND m.name = '2.0 Lusso';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 70, 1229
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'S';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 72, 1150
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SE';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 84, 1206
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'LTZ';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 140, 1362
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'LT Plus';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 124, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND m.name = '5.7';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 72, 1150
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SE';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 109, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'CDX';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 95, 1399
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'WTCC';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 125, 1301
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'CDX';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 109, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SE';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Otomatik', 109, 1598
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 51, 796
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'S';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 51, 796
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SE';
INSERT INTO vehicle_catalog_trims (model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT m.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 68, 995
FROM vehicle_catalog_models m
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND m.name = '1.0';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 75, 1300
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'LS';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin + LPG', 'Manuel', 66, 995
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SE';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 66, 995
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'SX';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 81, 1206
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
...
WHERE b.name = 'Chevrolet' 
  ...
  AND am.name = 'LT';
INSERT INTO vehicle_catalog_trims (alt_model_id, name, body_type, fuel_type, transmission, engine_power, engine_displacement)
SELECT am.id, NULL, 'Hatchback 5 KapÄ±', 'Benzin', 'Manuel', 82, 1206
FROM vehicle_catalog_alt_models am
JOIN vehicle_catalog_models m ON am.model_id = m.id
JOIN vehicle_catalog_series s ON m.series_id = s.id
JOIN vehicle_catalog_brands b ON s.brand_id = b.id
