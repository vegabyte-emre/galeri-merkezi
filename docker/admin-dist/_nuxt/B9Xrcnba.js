import{c as u}from"./B6IpsRfb.js";import{d as h,i as p,e as i,p as b,a as e,F as c,r as m,o as d,x,n,t as a,b as v,u as k}from"./CgVBj6KV.js";const _=u("ChevronDownIcon",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]),f={class:"space-y-6"},E={class:"space-y-6"},A={class:"flex items-start justify-between mb-4"},w={class:"flex-1"},q={class:"flex items-center gap-3 mb-2"},T={class:"text-sm font-mono text-gray-900 dark:text-white"},B={class:"text-sm text-gray-600 dark:text-gray-400"},P=["onClick"],Y={key:0,class:"space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700"},I={class:"p-4 bg-gray-50 dark:bg-gray-900 rounded-lg overflow-x-auto"},O={class:"text-sm"},D={class:"p-4 bg-gray-50 dark:bg-gray-900 rounded-lg overflow-x-auto"},U={class:"text-sm"},z={key:0},C={class:"overflow-x-auto"},R={class:"w-full text-sm"},S={class:"divide-y divide-gray-200 dark:divide-gray-700"},H={class:"px-4 py-2 font-mono text-gray-900 dark:text-white"},K={class:"px-4 py-2 text-gray-600 dark:text-gray-400"},L={class:"px-4 py-2"},G={class:"px-4 py-2 text-gray-600 dark:text-gray-400"},V=h({__name:"api-docs",setup(M){const o=p([]),y=p([{id:1,method:"GET",path:"/vehicles",description:"Tüm araçları listeler",requestExample:`GET /api/v1/vehicles
Headers:
