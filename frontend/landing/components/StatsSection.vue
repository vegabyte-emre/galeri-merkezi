      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        >
          ...
          <div class="mb-4 flex justify-center">
            <div class="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center group-hover:bg-white/20 group-hover:scale-110 transition-all duration-300">
          ...
          <div class="mb-2">
            <span 
              class="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white to-primary-200 bg-clip-text text-transparent"
              v-html="stat.value"
            ></span>
          </div>

          <!-- Label -->
          <div class="text-primary-100 text-lg font-medium">
            {{ stat.label }}
          </div>

          <!-- Description -->
          <div class="mt-2 text-primary-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            {{ stat.description }}
          </div>
        </div>
      </div>
