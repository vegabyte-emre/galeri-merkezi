      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 md:p-12 space-y-8">
        <section>
          ...
          <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400 ml-4">
            ...
            <li>Galeri bilgileri ve işletme detayları</li>
            <li>Kullanım verileri ve platform aktiviteleri</li>
            <li>Ödeme bilgileri (güvenli şekilde işlenir)</li>
          </ul>
        </section>

        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Veri Kullanımı</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
        ...
        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Veri Paylaşımı</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
            Kişisel verileriniz, yasal zorunluluklar dışında üçüncü taraflarla paylaşılmaz. 
            Sadece hizmet sağlayıcılarımız (bulut hosting, ödeme işlemcileri) ile sınırlı 
            ve güvenli şekilde paylaşılır.
          </p>
        </section>

        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Veri Güvenliği</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
            Verilerinizin güvenliği bizim önceliğimizdir. Endüstri standardı şifreleme 
            teknolojileri, güvenli sunucular ve düzenli güvenlik denetimleri ile verileriniz 
            korunmaktadır.
          </p>
        </section>

        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">5. Çerezler</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Haklarınız</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
        ...
        <section>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">7. İletişim</h2>
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
