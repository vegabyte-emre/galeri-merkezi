<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <!-- Footer -->
    <footer class="bg-gray-900 text-white py-16 mt-20 relative overflow-hidden">
      ...
      <div class="container-custom relative z-10">
        <div class="grid md:grid-cols-4 gap-12 mb-12">
          <div class="md:col-span-1">
            <div class="flex items-center gap-2 mb-4">
              <span class="text-xl font-semibold" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif;">Otobia</span>
            </div>
            ...
            <!-- App Store Buttons -->
            <div class="flex flex-col gap-3">
              <a href="#" class="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 rounded-lg transition-colors group">
                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                </svg>
                <div class="text-left">
                  <div class="text-[10px] text-gray-400 group-hover:text-gray-300">Yakında</div>
        ...
        <div class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-gray-400 text-sm">
            &copy; {{ new Date().getFullYear() }} Otobia. Tüm hakları saklıdır.
          </p>
